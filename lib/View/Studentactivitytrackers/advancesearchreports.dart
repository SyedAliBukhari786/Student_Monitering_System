...
class SearchReports extends StatefulWidget {
  final String classId;

  const SearchReports({Key? key, required this.classId}) : super(key: key);

  @override
  State<SearchReports> createState() => _SearchReportsState();
}

class _SearchReportsState extends State<SearchReports> {
  ...
  void _navigateToReportDetails(String reportId) {
    Navigator.push(
      context,
      MaterialPageRoute(builder: (context) => ReportDetails(reportId: reportId)),
    );
  }
}
